<x-admin-layout title="Ubah Siswa">
  <div class="row">
    <div class="col-12">
      <div class="card w-100">
        <div class="card-body">
          <h5 class="card-title fs-6 fw-semibold mb-4">Ubah Siswa</h5>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="text" name="no_ujian" id="no_ujian"
                    ...
                    value="{{ old('no_ujian', $student->no_ujian) }}" autofocus autocomplete="off">
                  @error('no_ujian')
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="nis" id="nis"
                    ...
                    value="{{ old('nis', $student->nis) }}" autocomplete="off">
                  @error('nis')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="nisn" id="nisn"
                    ...
                    value="{{ old('nisn', $student->nisn) }}" autocomplete="off">
                  @error('nisn')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="text" name="nama" id="nama"
                    ...
                    value="{{ old('nama', $student->nama) }}" autocomplete="off">
                  @error('nama')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="text" name="ttl" id="ttl"
                    ...
                    value="{{ old('ttl', $student->ttl) }}" autocomplete="off">
                  @error('ttl')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="text" name="ortu" id="ortu"
                    ...
                    value="{{ old('ortu', $student->ortu) }}" autocomplete="off">
                  @error('ortu')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="text" name="kls" id="kls"
                    ...
                    value="{{ old('kls', $student->kls) }}" autocomplete="off">
                  @error('kls')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_pai" id="n_pai"
                    ...
                    placeholder="Masukkan Nilai Pendidikan Agama Islam" value="{{ old('n_pai', $student->n_pai) }}"
                    autocomplete="off">
                  @error('n_pai')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_pkn" id="n_pkn"
                    ...
                    placeholder="Masukkan Nilai Pendidikan Kewarganegaraan"
                    value="{{ old('n_pkn', $student->n_pkn) }}" autocomplete="off">
                  @error('n_pkn')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_bin" id="n_bin"
                    ...
                    placeholder="Masukkan Nilai Bahasa Indonesia" value="{{ old('n_bin', $student->n_bin) }}"
                    autocomplete="off">
                  @error('n_bin')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_mat" id="n_mat"
                    ...
                    value="{{ old('n_mat', $student->n_mat) }}" autocomplete="off">
                  @error('n_mat')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_ipa" id="n_ipa"
                    ...
                    placeholder="Masukkan Nilai Pengetahuan Alam" value="{{ old('n_ipa', $student->n_ipa) }}"
                    autocomplete="off">
                  @error('n_ipa')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_ips" id="n_ips"
                    ...
                    placeholder="Masukkan Nilai Ilmu Pengetahuan Sosial" value="{{ old('n_ips', $student->n_ips) }}"
                    autocomplete="off">
                  @error('n_ips')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_big" id="n_big"
                    ...
                    placeholder="Masukkan Nilai Bahasa Inggris" value="{{ old('n_big', $student->n_big) }}"
                    autocomplete="off">
                  @error('n_big')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_sb" id="n_sb"
                    ...
                    value="{{ old('n_sb', $student->n_sb) }}" autocomplete="off">
                  @error('n_sb')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_pjok" id="n_pjok"
                    ...
                    value="{{ old('n_pjok', $student->n_pjok) }}" autocomplete="off">
                  @error('n_pjok')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_pkr" id="n_pkr"
                    ...
                    value="{{ old('n_pkr', $student->n_pkr) }}" autocomplete="off">
                  @error('n_pkr')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_bde" id="n_bde"
                    ...
                    placeholder="Masukkan Nilai Bahasa Daerah" value="{{ old('n_bde', $student->n_bde) }}"
                    autocomplete="off">
                  @error('n_bde')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="n_mulok2" id="n_mulok2"
                    ...
                    placeholder="Masukkan Nilai Muatan Lokal 2" value="{{ old('n_mulok2', $student->n_mulok2) }}"
                    autocomplete="off">
                  @error('n_mulok2')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="col-12 col-md-6 mb-4">
                <div class="form-group">
                  ...
                  <input type="number" name="rata2" id="rata2"
                    ...
                    value="{{ old('rata2', $student->rata2) }}" autocomplete="off">
                  @error('rata2')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
